...
// public Contact(String id, String name, String phoneNumber, String
// companyName, double salary, String birthday) {
// this.id = id;
// this.name = name;
...
// System.out.println("=======================iFRIEND CONTACT
// ORGANIZER============================");
// System.out.println("\n[01] Add Contacts");
// System.out.println("\n[02] Update Contacts");
// System.out.println("\n[03] Delete Contacts");
...
// Contact contactDetails = new Contact(id, name, phoneNumber, companyName,
// salary, birthday);
// contactArray[contactArray.length - 1] = contactDetails;
...
// for (int i = 0; i < contactArray.length; i++) {
// if (contactArray[i].getName().equals(nameOrPhone) ||
// contactArray[i].getPhoneNumber().equals(nameOrPhone)) {
// return i;
// }
// }
// return -1;
...
// // tempIdArray[i], tempNameArray[i],
// // tempPhoneNumberArray[i], tempCompanyNameArray[i], tempSalaryArray[i],
// // tempBirthdayArray[i]);
// // }
